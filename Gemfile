...
# gem 'parliament-ruby', '0.4.1'

gem 'parliament-ruby', git: 'https://github.com/katylouise/parliament-ruby', branch: 'katylouise/website-568_update-decorators-for-lords'
