...
describe ContactPoint do
  let(:contact_point) { ContactPoint.new({ id: '123', email: 'test@example.com', telephone: '0800987654321', faxNumber: '09876554321', streetAddress: '16 Roman Road', addressLocality: 'London', postalCode: 'SW1A 3BB', graph: RDF::Graph.new }) }
